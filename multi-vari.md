...
## Swift Multiple Variables
Declare multiple variable or constants on one line when  they share a type.

## Multiple Variables Declared
Declaring multiple variables or constants on one line is only recommended if it stays easy dto read.
